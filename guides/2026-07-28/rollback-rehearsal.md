...
Use a disposable environment and synthetic or public inputs. Save the starting state, version, configuration, permissions, and a checksum or version-control reference. The evidence pack should include licensed media, prompt records, temporal-consistency checks, and usage-rights review.
