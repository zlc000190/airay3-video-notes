# AI Ray 3 safe fallback decision tree
...
Define the ordered response for unavailable dependencies, incomplete outputs, stale evidence, policy conflicts, and exceeded cost or time limits. Base choices on licensed source media, saved prompts, render settings, temporal checks, and usage-rights evidence.
