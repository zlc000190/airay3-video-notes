# AI Ray 3 dependency and data-lineage map
...
Document the path from an authorized input to the final output. For every step, record the component owner, version, input classification, transformation, storage location, retention period, and next recipient. Include licensed source media, saved prompts, render settings, temporal checks, and usage-rights evidence.
